$( document ).ready(function() {
    render_chart(json_data = "data/sirohi_tool_days_monthly.json");
 });
...
svg.append("text")
      ...
      .text("Number of Days");
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Number of Days* Tools Section of Platform is Used (Month wise)");
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*MIT Tools, some of the Math Tools and all English tools are not considered.");
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*By all students both logged-in and anonymous");
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					var str;
					if(date == "Sirohi"){
						str = "data/sirohi_tool_days_monthly.json";
					}else if(date == "Jaipur"){
						str = "data/jaipur_tool_days_monthly.json";
					}else if(date == "Warangal"){
						str = "data/warangal_tool_days_monthly.json";
					}else if(date == "Rangareddy"){
						str = "data/rangareddy_tool_days_monthly.json";
					}else{
					//All states top 50 schools
						str = "data/karimnagar_tool_days_monthly.json";
					}
