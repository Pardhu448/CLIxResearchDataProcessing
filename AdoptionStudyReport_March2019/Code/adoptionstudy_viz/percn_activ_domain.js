$( document ).ready(function() {
    render_chart(json_data = "data/sirohi_module_percn_activ_monthly.json");
 });
...
svg.append("text")
      ...
      .text("Number of Students");
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Range of Number of Students Visiting atleast 50% of Module Activities (Month wise)");
...
svg.append("text")
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					var str;
					if(date == "Sirohi"){
						str = "data/sirohi_module_percn_activ_monthly.json";
					}else if(date == "Jaipur"){
						str = "data/jaipur_module_percn_activ_monthly.json";
					}else if(date == "Warangal"){
						str = "data/warangal_module_percn_activ_monthly.json";
					}else if(date == "Karimnagar"){
						str = "data/karimnagar_module_percn_activ_monthly.json";
					}else{
 ...
 //   var dataset
    ...
    //    .domain(dataset["categories"])
    //    .rangeRoundBands([0, width], .08);
   //Hard coding of yaxis range for telangana districts
    var y = d3.scale.linear()
        .domain([0, 30])
        .range([height, 0]);
    //console.log(yGroupMin)
