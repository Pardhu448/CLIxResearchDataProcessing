$( document ).ready(function() {
    render_chart(json_data = "data/sirohi_module_stud_monthly.json");
 });
...
svg.append("text")
      ...
      .text("Number of Students");
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Range of Number of Students* Engaged with Modules Section of the Platform (Month wise)");
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*Across all schools in the state and all students both logged-in and buddy users are considered");
    ...
    legend.selectAll('text')
      ...
      .enter()
    .append("text")
    .attr("x", width-margin.right  + 40 + 25 + 10)
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					var str;
					if(date == "Sirohi"){
						str = "data/sirohi_module_stud_monthly.json";
					}else if(date == "Jaipur"){
						str = "data/jaipur_module_stud_monthly.json";
					}else if(date == "Warangal"){
						str = "data/warangal_module_stud_monthly.json";
					}else if(date == "Karimnagar"){
						str = "data/karimnagar_module_stud_monthly.json";
					}else{
					//All states top 50 schools
						str = "data/rangareddy_module_stud_monthly.json";
					}
...
svg.append("text")
    ...
    legend.selectAll('text')
      ...
      .enter()
    .append("text")
    .attr("x", width - margin.right + 25 +  40 + 10)
    .attr("y", function(d, i){ return i *  20 + 9;})
    .text(function(d){return d});
